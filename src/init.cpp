...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 43735 or testnet: 143735)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 43736 or testnet: 143736)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Diamint Wiki for SSL setup instructions)") + "\n" +
